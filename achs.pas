...
var
    ...
    'ОРА-ОРА-ОРА!',
    'Победить Костю в финальной битве рута Трипа',
    'Подразумевается при получении ачивки "SaShok''s Bizzare Adventure". Сама битва непроста: придётся не только яростно долбить по клавишам (особенно в режиме "сергеевской ярости"), но и поджидать возможность контратаковать, когда снизится получаемый урон (на что может уйти вплоть до пары минут).');
